 ...
 */
public class MGsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
     ...
     */
    public MGsonHttpMessageConverter() {
        this(new Gson());
    }
     ...
     */
    public MGsonHttpMessageConverter(boolean serializeNulls) {
     ...
     */
    public MGsonHttpMessageConverter(Gson gson) {
